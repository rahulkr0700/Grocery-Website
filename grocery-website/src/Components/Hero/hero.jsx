   ...
   <section>
         <div className=' min-h-screen max-w-[1400px] mx-auto px-10 flex md:flex-row flex-col items-center md:pt-25 pt-35'>
             ...
             <div className='flex-1'>
                ...
                <p className='text-zinc-600 md:text-lg  text-md max-w-[530px] mt-5 mb-10'>Bred for a high content of beneficial substance. Our products are all fresh and healthy</p>
