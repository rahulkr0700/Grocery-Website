    ...
    <footer className="bg-zinc-100 py-20">
      <div className=" flex flex-wrap gap-y-10 max-w-[1400px] mx-auto px-10">
        ...
        <ul className="flex-1">
         ...
         <ul className="flex-1">
            <li>
                <h5 className="text-zinc-800 text-2xl font-bold">Supports</h5>
            </li>
        ...
        <div className="flex-1">
            ...
            <div className=" flex bg-white p-1 rounded-lg mt-6 ">
                <input  className=" flex-1 h-[5vh] focus:outline-none pl-4" type="email" name="email" id="email" autoComplete="off" placeholder="Email Address" />
